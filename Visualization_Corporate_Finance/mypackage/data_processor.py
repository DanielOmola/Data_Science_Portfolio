...
def load_raw_data():
  ...
  #######################################################################################
  """
  companies = pd.read_csv('https://www.dropbox.com/s/rs6ooeqmb872dxh/us-companies.zip?dl=1',compression='zip', header= 0, sep=';')
  industries = pd.read_csv('https://www.dropbox.com/s/bbzw4m936thdrfo/industries.zip?dl=1',compression='zip', header= 0, sep=';')
  markets = pd.read_csv('https://www.dropbox.com/s/5jkqpf43ujenn42/markets.zip?dl=1',compression='zip', header= 0, sep=';')
  balance_sheet = pd.read_csv('https://www.dropbox.com/s/64r837x3lnuppo5/us-balance-annual.zip?dl=1',compression='zip', header= 0, sep=';')
  income = pd.read_csv('https://www.dropbox.com/s/95oqmtz1sowz3k3/us-income-annual.zip?dl=1',compression='zip', header= 0, sep=';')
